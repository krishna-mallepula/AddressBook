...
import com.instagram.android.InstagramDialog.OAuthDialogListener;
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					String profileUrl = jsonObj.getJSONObject("user").getString("profile_picture");
					
					mSession.storeAccessToken(mAccessToken, id, user, name,profileUrl);
