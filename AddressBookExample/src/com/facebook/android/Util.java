...
public final class Util {
	public static final String IMAGELINK = "https://graph.facebook.com/";
	public static final String NORMAL_SIZE_PIC = "/picture?type=normal";
	public static final String LARGE_SIZE_PIC = "/picture?type=large";
	public static final String SMALL_SIZE_PIC = "/picture?type=small";
	public static final String SQUARE_SIZE_PIC = "/picture?type=square";
	public static final String ALBUM_COVER_PIC = "/picture?type=album&access_token=";
	public static final String[] FACEBOOK_PERMISSIONS = { "user_photos",
			"publish_stream", "read_stream", "friends_photos" };
	public static final String TAGGED_PHOTOS_ID = "123456789";
	public static final int MIN_SRC_BIG_DIMENSION = 720;
